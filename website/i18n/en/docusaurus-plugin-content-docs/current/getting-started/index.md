...
- Prototype scenes and gameplay with natural language.
...
- **[Your First Prompt](./first-prompt.md)** — End-to-end tutorial.
- **[Choosing an MCP Client](./clients.md)** — A capability matrix across supported clients.

---

MIT licensed. The upstream project is sponsored and maintained by [Aura](https://www.tryaura.dev/). Not affiliated with Unity Technologies.
